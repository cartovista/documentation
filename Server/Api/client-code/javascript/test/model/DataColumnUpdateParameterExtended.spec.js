...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataColumnUpdateParameterExtended', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.DataColumnUpdateParameterExtended();
      });

      it('should create an instance of DataColumnUpdateParameterExtended', function() {
        // TODO: update the code to test DataColumnUpdateParameterExtended
        expect(instance).to.be.a(CartoVistaserverapiv1.DataColumnUpdateParameterExtended);
      });

      it('should have the property columnIdentifier (base name: "ColumnIdentifier")', function() {
        // TODO: update the code to test the property columnIdentifier
        expect(instance).to.have.property('columnIdentifier');
        // expect(instance.columnIdentifier).to.be(expectedValueLiteral);
      });
