...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataColumnUpdateParameter', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.DataColumnUpdateParameter();
      });

      it('should create an instance of DataColumnUpdateParameter', function() {
        // TODO: update the code to test DataColumnUpdateParameter
        expect(instance).to.be.a(CartoVistaserverapiv1.DataColumnUpdateParameter);
      });
