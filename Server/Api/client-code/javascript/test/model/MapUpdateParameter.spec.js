...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MapUpdateParameter', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.MapUpdateParameter();
      });

      it('should create an instance of MapUpdateParameter', function() {
        // TODO: update the code to test MapUpdateParameter
        expect(instance).to.be.a(CartoVistaserverapiv1.MapUpdateParameter);
      });
