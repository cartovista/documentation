...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IsochroneParams', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.IsochroneParams();
      });

      it('should create an instance of IsochroneParams', function() {
        // TODO: update the code to test IsochroneParams
        expect(instance).to.be.a(CartoVistaserverapiv1.IsochroneParams);
      });
