...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FeatureLongLatCreateParameter', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.FeatureLongLatCreateParameter();
      });

      it('should create an instance of FeatureLongLatCreateParameter', function() {
        // TODO: update the code to test FeatureLongLatCreateParameter
        expect(instance).to.be.a(CartoVistaserverapiv1.FeatureLongLatCreateParameter);
      });
