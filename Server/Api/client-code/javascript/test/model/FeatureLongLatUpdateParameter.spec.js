...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FeatureLongLatUpdateParameter', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.FeatureLongLatUpdateParameter();
      });

      it('should create an instance of FeatureLongLatUpdateParameter', function() {
        // TODO: update the code to test FeatureLongLatUpdateParameter
        expect(instance).to.be.a(CartoVistaserverapiv1.FeatureLongLatUpdateParameter);
      });
