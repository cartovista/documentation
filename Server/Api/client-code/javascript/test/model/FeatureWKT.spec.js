...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FeatureWKT', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.FeatureWKT();
      });

      it('should create an instance of FeatureWKT', function() {
        // TODO: update the code to test FeatureWKT
        expect(instance).to.be.a(CartoVistaserverapiv1.FeatureWKT);
      });
