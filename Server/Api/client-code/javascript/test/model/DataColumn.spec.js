...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataColumn', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.DataColumn();
      });

      it('should create an instance of DataColumn', function() {
        // TODO: update the code to test DataColumn
        expect(instance).to.be.a(CartoVistaserverapiv1.DataColumn);
      });
      ...
      it('should have the property dataTableIdentifier (base name: "DataTableIdentifier")', function() {
        // TODO: update the code to test the property dataTableIdentifier
        expect(instance).to.have.property('dataTableIdentifier');
        // expect(instance.dataTableIdentifier).to.be(expectedValueLiteral);
      });
