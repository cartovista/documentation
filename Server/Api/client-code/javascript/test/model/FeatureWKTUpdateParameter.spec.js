...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FeatureWKTUpdateParameter', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.FeatureWKTUpdateParameter();
      });

      it('should create an instance of FeatureWKTUpdateParameter', function() {
        // TODO: update the code to test FeatureWKTUpdateParameter
        expect(instance).to.be.a(CartoVistaserverapiv1.FeatureWKTUpdateParameter);
      });
