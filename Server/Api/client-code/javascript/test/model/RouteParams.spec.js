...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RouteParams', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.RouteParams();
      });

      it('should create an instance of RouteParams', function() {
        // TODO: update the code to test RouteParams
        expect(instance).to.be.a(CartoVistaserverapiv1.RouteParams);
      });
