...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FeatureGeoJSONCreateParameter', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.FeatureGeoJSONCreateParameter();
      });

      it('should create an instance of FeatureGeoJSONCreateParameter', function() {
        // TODO: update the code to test FeatureGeoJSONCreateParameter
        expect(instance).to.be.a(CartoVistaserverapiv1.FeatureGeoJSONCreateParameter);
      });
