...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReverseGeocodeParams', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.ReverseGeocodeParams();
      });

      it('should create an instance of ReverseGeocodeParams', function() {
        // TODO: update the code to test ReverseGeocodeParams
        expect(instance).to.be.a(CartoVistaserverapiv1.ReverseGeocodeParams);
      });
