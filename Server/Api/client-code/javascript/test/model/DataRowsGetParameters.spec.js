...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataRowsGetParameters', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.DataRowsGetParameters();
      });

      it('should create an instance of DataRowsGetParameters', function() {
        // TODO: update the code to test DataRowsGetParameters
        expect(instance).to.be.a(CartoVistaserverapiv1.DataRowsGetParameters);
      });
