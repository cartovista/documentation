...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserUpdateParameter', function() {
      beforeEach(function() {
        instance = new CartoVistaserverapiv1.UserUpdateParameter();
      });

      it('should create an instance of UserUpdateParameter', function() {
        // TODO: update the code to test UserUpdateParameter
        expect(instance).to.be.a(CartoVistaserverapiv1.UserUpdateParameter);
      });
