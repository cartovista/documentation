...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CartoVistaserverapiv1.DataColumnUpdateParameter = factory(root.CartoVistaserverapiv1.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DataColumnUpdateParameter model module.
   * @module model/DataColumnUpdateParameter
   * @version v1
   */

  /**
   * Constructs a new <code>DataColumnUpdateParameter</code>.
   * @alias module:model/DataColumnUpdateParameter
   * @class
   */
  ...
  /**
   * Constructs a <code>DataColumnUpdateParameter</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DataColumnUpdateParameter} obj Optional instance to populate.
   * @return {module:model/DataColumnUpdateParameter} The populated <code>DataColumnUpdateParameter</code> instance.
   */
