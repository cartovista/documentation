...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CartoVistaserverapiv1.DataColumnUpdateParameterExtended = factory(root.CartoVistaserverapiv1.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DataColumnUpdateParameterExtended model module.
   * @module model/DataColumnUpdateParameterExtended
   * @version v1
   */

  /**
   * Constructs a new <code>DataColumnUpdateParameterExtended</code>.
   * @alias module:model/DataColumnUpdateParameterExtended
   * @class
   */
  ...
  /**
   * Constructs a <code>DataColumnUpdateParameterExtended</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DataColumnUpdateParameterExtended} obj Optional instance to populate.
   * @return {module:model/DataColumnUpdateParameterExtended} The populated <code>DataColumnUpdateParameterExtended</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('ColumnIdentifier'))
        obj.columnIdentifier = ApiClient.convertToType(data['ColumnIdentifier'], 'String');
  ...
  /**
   * @member {String} columnIdentifier
   */
  exports.prototype.columnIdentifier = undefined;
