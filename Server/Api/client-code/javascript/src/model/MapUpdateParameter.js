...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CartoVistaserverapiv1.MapUpdateParameter = factory(root.CartoVistaserverapiv1.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MapUpdateParameter model module.
   * @module model/MapUpdateParameter
   * @version v1
   */

  /**
   * Constructs a new <code>MapUpdateParameter</code>.
   * @alias module:model/MapUpdateParameter
   * @class
   */
  ...
  /**
   * Constructs a <code>MapUpdateParameter</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MapUpdateParameter} obj Optional instance to populate.
   * @return {module:model/MapUpdateParameter} The populated <code>MapUpdateParameter</code> instance.
   */
  ...
  /**
   * @member {module:model/MapUpdateParameter.LanguageEnum} language
   */
