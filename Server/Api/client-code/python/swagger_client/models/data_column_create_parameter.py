...
class DataColumnCreateParameter(object):
    ...
    def __init__(self, identifier=None, carto_vista_data_type=None, name=None, description=None, metadata=None, units=None, aggregation_type=None, mappable=None, precision=None, round_to_precision=None, time_stamp=None, time_stamp_accuracy=None, not_available_values=None, value_to_convert=None, system_identifier=None):  # noqa: E501
