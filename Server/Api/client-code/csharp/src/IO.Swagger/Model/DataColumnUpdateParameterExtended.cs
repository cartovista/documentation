...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DataColumnUpdateParameterExtended :  IEquatable<DataColumnUpdateParameterExtended>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataColumnUpdateParameterExtended" /> class.
        /// </summary>
        /// <param name="columnIdentifier">columnIdentifier.</param>
        ...
        /// <summary>
        /// Gets or Sets ColumnIdentifier
        /// </summary>
        [DataMember(Name="ColumnIdentifier", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataColumnUpdateParameterExtended {\n");
        ...
        {
            return this.Equals(input as DataColumnUpdateParameterExtended);
        }

        /// <summary>
        /// Returns true if DataColumnUpdateParameterExtended instances are equal
        /// </summary>
        /// <param name="input">Instance of DataColumnUpdateParameterExtended to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataColumnUpdateParameterExtended input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ColumnIdentifier == input.ColumnIdentifier ||
                    (this.ColumnIdentifier != null &&
                    this.ColumnIdentifier.Equals(input.ColumnIdentifier))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ColumnIdentifier != null)
                    hashCode = hashCode * 59 + this.ColumnIdentifier.GetHashCode();
