...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MapCreateParameter :  IEquatable<MapCreateParameter>, IValidatableObject
    {
        /// <summary>
        /// Defines Language
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MapCreateParameter" /> class.
        /// </summary>
        ...
        public MapCreateParameter(Guid? systemIdentifier = default(Guid?), string title = default(string), string uniqueIdentifier = default(string), string description = default(string), LanguageEnum? language = default(LanguageEnum?), bool? editable = default(bool?), string seoTitle = default(string), string seoDescription = default(string), string seoCustomHTML = default(string), bool? scoringEnabled = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MapCreateParameter {\n");
        ...
        {
            return this.Equals(input as MapCreateParameter);
        }

        /// <summary>
        /// Returns true if MapCreateParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of MapCreateParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MapCreateParameter input)
        {
            if (input == null)
                return false;
