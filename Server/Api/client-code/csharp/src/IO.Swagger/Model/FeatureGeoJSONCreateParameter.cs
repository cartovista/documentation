...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FeatureGeoJSONCreateParameter :  IEquatable<FeatureGeoJSONCreateParameter>, IValidatableObject
    {
        /// <summary>
        /// Defines FeatureType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FeatureGeoJSONCreateParameter" /> class.
        /// </summary>
        ...
        public FeatureGeoJSONCreateParameter(string geoJSON = default(string), List<string> dataColumnsIdentifiers = default(List<string>), List<Object> values = default(List<Object>), string proj4 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FeatureGeoJSONCreateParameter {\n");
        ...
        {
            return this.Equals(input as FeatureGeoJSONCreateParameter);
        }

        /// <summary>
        /// Returns true if FeatureGeoJSONCreateParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of FeatureGeoJSONCreateParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeatureGeoJSONCreateParameter input)
        {
            if (input == null)
                return false;
