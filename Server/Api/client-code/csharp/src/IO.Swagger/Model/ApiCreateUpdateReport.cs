...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApiCreateUpdateReport :  IEquatable<ApiCreateUpdateReport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiCreateUpdateReport" /> class.
        /// </summary>
        ...
        public ApiCreateUpdateReport(int? updateCount = default(int?), int? createCount = default(int?), List<string> insertedIdentifiers = default(List<string>), List<string> updatedIdentifiers = default(List<string>), int? errorCount = default(int?), List<ErrorDetail> errorDetails = default(List<ErrorDetail>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiCreateUpdateReport {\n");
        ...
        {
            return this.Equals(input as ApiCreateUpdateReport);
        }

        /// <summary>
        /// Returns true if ApiCreateUpdateReport instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiCreateUpdateReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiCreateUpdateReport input)
        {
            if (input == null)
                return false;
