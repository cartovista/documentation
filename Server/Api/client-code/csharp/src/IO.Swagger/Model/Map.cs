...
namespace IO.Swagger.Model
{
    ...
    public partial class Map :  IEquatable<Map>, IValidatableObject
    {
        ...
        public Map(Guid? id = default(Guid?), string title = default(string), string uniqueIdentifier = default(string), string description = default(string), LanguageEnum? language = default(LanguageEnum?), StatusEnum? status = default(StatusEnum?), TypeEnum? type = default(TypeEnum?), bool? isMapTerritoryReady = default(bool?), bool? editable = default(bool?), string seoTitle = default(string), string seoDescription = default(string), string seoCustomHTML = default(string), bool? scoringEnabled = default(bool?))
        {
            this.Id = id;
            this.Title = title;
