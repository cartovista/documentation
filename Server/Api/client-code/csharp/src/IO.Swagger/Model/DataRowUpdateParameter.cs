...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DataRowUpdateParameter :  IEquatable<DataRowUpdateParameter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataRowUpdateParameter" /> class.
        /// </summary>
        /// <param name="dataColumnsIdentifiers">dataColumnsIdentifiers.</param>
        /// <param name="values">values.</param>
        public DataRowUpdateParameter(List<string> dataColumnsIdentifiers = default(List<string>), List<Object> values = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataRowUpdateParameter {\n");
        ...
        {
            return this.Equals(input as DataRowUpdateParameter);
        }

        /// <summary>
        /// Returns true if DataRowUpdateParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of DataRowUpdateParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataRowUpdateParameter input)
        {
            if (input == null)
                return false;
