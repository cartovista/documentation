...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FeatureLongLatCreateParameter :  IEquatable<FeatureLongLatCreateParameter>, IValidatableObject
    {
        /// <summary>
        /// Defines FeatureType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FeatureLongLatCreateParameter" /> class.
        /// </summary>
        ...
        public FeatureLongLatCreateParameter(double? longitude = default(double?), double? latitude = default(double?), List<string> dataColumnsIdentifiers = default(List<string>), List<Object> values = default(List<Object>), string proj4 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FeatureLongLatCreateParameter {\n");
        ...
        {
            return this.Equals(input as FeatureLongLatCreateParameter);
        }

        /// <summary>
        /// Returns true if FeatureLongLatCreateParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of FeatureLongLatCreateParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeatureLongLatCreateParameter input)
        {
            if (input == null)
                return false;
